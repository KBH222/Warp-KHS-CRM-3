...
export const API_ENDPOINTS = {
    ...
    CUSTOMER_JOBS: (id) => `/api/customers/${id}/jobs`,
    // Jobs
    JOBS: '/api/jobs',
    JOB_BY_ID: (id) => `/api/jobs/${id}`,
    JOB_MATERIALS: (id) => `/api/jobs/${id}/materials`,
    JOB_ASSIGN: (id) => `/api/jobs/${id}/assign`,
    JOB_STATUS: (id) => `/api/jobs/${id}/status`,
    // Materials
    MATERIALS: '/api/materials',
    MATERIAL_BY_ID: (id) => `/api/materials/${id}`,
